  ...
  return (
    <div className="footer footer-expand-lg">
      ...
      <footer className="text-center text-lg-start text-muted footer-custom">
        ...
        <section className="footer-body mt-3">
          <div className="container text-center text-md-start mt-5">
            <div className="row mt-3">
              <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                ...
                <Link to={""} className="text-reset">Hakkımızda</Link>
                  
                
              </div>

              <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                <h6 className="text-uppercase fw-bold mb-4">Araç Kiralama</h6>
                <p>
              ...
              <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                <h6 className="text-uppercase fw-bold mb-4">DESTEK</h6>
                <p>
                  <Link to={"/new-products"} className="text-reset">
                    Yardım
                  </Link>
                </p>
                <p>
